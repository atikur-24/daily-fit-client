    ...
    return (
        ...
        <div id="slide1" className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide3" className="btn btn-circle bg-[#f34e3a] border-[#f34e3a] text-white hover:text-black">❮</a>
                <a href="#slide2" className="btn btn-circle bg-[#f34e3a] border-[#f34e3a] text-white hover:text-black">❯</a>
            </div>
            <div className='absolute top-16 md:top-32 space-y-4 lg:space-y-10 w-1/2 ml-16 md:ml-20'>
                ...
                <p className='md:tracking-wide lg:leading-10 capitalize text-sm md:text-[18px] md:font-medium text-white'>Unleash your potential, achieve unmatched results. Join Daily Fit for transformative fitness experiences that go beyond expectations</p>
        ...
        <div id="slide2" className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide1" className="btn btn-circle bg-[#f34e3a] border-[#f34e3a] text-white hover:text-black">❮</a>
                <a href="#slide3" className="btn btn-circle bg-[#f34e3a] border-[#f34e3a] text-white hover:text-black">❯</a>
            </div>
            <div className='absolute top-16 md:top-32 space-y-4 lg:space-y-16 w-1/2 ml-16 md:ml-20'>
                ...
                <p className='md:tracking-wide lg:leading-10 capitalize text-sm md:text-[18px] md:font-medium text-white'>Transform your fitness journey with Daily Fit: Join us today for unparalleled results and a healthier, stronger you</p>
        ...
        <div id="slide3" className="carousel-item relative w-full">
            ...
            <div className='absolute top-16 md:top-32 space-y-4 lg:space-y-16 w-1/2 ml-16 md:ml-20'>
                ...
                <p className='md:tracking-wide lg:leading-10 capitalize text-sm md:text-[18px] md:font-medium text-white'>Discover the Ultimate Fitness Destination: Unleash Your Potential at Daily Fit for Unmatched Workout Experiences</p>
