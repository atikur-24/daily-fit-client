...
const Navbar = () => {
    ...
    const navItems = (
        <>
            ...
            <li>
                <NavLink className={({ isActive }) => (isActive ? "active" : "default")} to="/classes">
                    Classes
                </NavLink>
            </li>
            <li>
            ...
            {/* <li>
        <NavLink className={({ isActive }) => (isActive ? "active" : "default")} to="/services">
          Services
        </NavLink>
      </li> */}
            {/* <li>
        <NavLink className={({ isActive }) => (isActive ? "active" : "default")} to="/aboutUs">
          About Us
        </NavLink>
      </li> */}
            {/* <li>
        <NavLink className={({ isActive }) => (isActive ? "active" : "default")} to="/contactUs">
          Contact
        </NavLink>
      </li> */}
            {user && (
                <li>
                    <NavLink className={({ isActive }) => (isActive ? "active" : "default")} to={dashboardLink}>
                        Dashboard{" "}
                    </NavLink>
                </li>
            )}
    ...
    return (
        <div className="navbar absolute top-0 lg:pt-4 lg:pl-20 text-white z-20">
            <div className="navbar-start z-10">
                ...
                <Link to="/">
                    <img className="h-10 lg:h-14 mr-5 lg:mr-20" src={logo} alt="logo" />
                </Link>
            </div>
            ...
            <div className="navbar-end lg:mr-28">
                <div className="mr-10">
                    <label onChange={handleThemeToggle} className="swap swap-rotate pt-2">
                        <input type="checkbox" />
                ...
                {user ? (
                    <button onClick={handleLogout} className="btn btn-sm text-black">
                        Logout
                    </button>
                ) : (
                    <Link to="/login" className="btn btn-sm text-black">
                        Login
                    </Link>
                )}
                {user && (
