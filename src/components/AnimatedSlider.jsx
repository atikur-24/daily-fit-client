...
const IMAGES = [
    'https://img.freepik.com/free-photo/muscular-man-doing-push-ups-one-hand_7502-4775.jpg?w=740&t=st=1686830663~exp=1686831263~hmac=85b41df74950ce4f94de4cba7a27f9cb6bbae08eab7a1ffe7a63d8ed3be035be',
    'https://img.freepik.com/free-photo/young-healthy-man-athlete-doing-exercise-with-ropes-gym-single-male-model-practicing-hard-training-his-upper-body-concept-healthy-lifestyle-sport-fitness-bodybuilding-wellbeing_155003-27879.jpg?w=740&t=st=1686830730~exp=1686831330~hmac=f2b40115663260b5dbc00bc95fdf376f171bd0077d859313dceed2bf8adc7173',
    'https://img.freepik.com/premium-photo/man-fitness_133748-6122.jpg?w=740',
]
        ...
        <div className={styles.container__inner}>
          {transitions((springs, item) => (
            <animated.div className={styles.img__container} style={springs}>
              <img className="w-full" src={IMAGES[item]} />
            </animated.div>
          ))}
